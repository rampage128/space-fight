...
public class AdvancedList<T> extends AbstractController implements ListBox<T>, ListBoxView<T> {
  ...
  public void bind(
    ...
    displayItems = (int)Math.floor(getHeight() / (float)labelTemplateHeight);
  ...
  private void initSelectionMode(final AdvancedListImpl<T> listBoxImpl, final String selectionMode, final String forceSelection) {
